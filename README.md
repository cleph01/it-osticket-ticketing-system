...
<p>
  osTicket is a widely used and trusted open source support ticketing system. Easily scale and streamline your customer service and drastically improve your customer experience.</p>

<p>
  This project will outline the steps involved in installing, configuring, and working some mock tickets through their lifecycle (create, interact, close).
</p>
<br />
<hr />
